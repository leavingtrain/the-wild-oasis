...
function Table({ gridcols, children }) {
	return (
...
function Header({ children }) {
	...
	return (
		<StyledHeader role="row" as="header" gridcols={gridcols}>
			{children}
		</StyledHeader>
	);
}
...
function Row({ children }) {
	...
	return (
		<StyledRow role="row" gridcols={gridcols}>
			{children}
		</StyledRow>
	);
}
...
function Body({ items, render }) {
	if (!items || !items.length) return <Empty>no data bro</Empty>;
